...
//                        Element childElement = obj;
     ...
     * @param out_file 输出文件
     */
    public static void mergeXmls(File dynamic_xml, File LayoutBase, String out_file){
//        getIds(LayoutBase);
...
//        File dynamic_xml = new File("C:\\Users\\gaoshu\\Desktop\\textExamples\\onpc.xml");
//        File layout_base = new File("C:\\Accessibility\\DataSet\\owleyeDataset\\onpc1.10\\新建文件夹\\onpc-v1.10\\res\\layout");
