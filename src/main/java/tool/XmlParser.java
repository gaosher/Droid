...
public class XmlParser {
    ...
    static final String [] TextualViews = {
            "TextView", "Button", "EditText", "Spinner"
    };
...
//            else if(ele_name.contains("Spinner")) ViewType = SPINNER;
//            else if(ele_name.contains("ScrollView")) ViewType = SCROLL_VIEW;
...
//        String filename = "mergedXmlBase\\openTrackMergeTest.xml";
//        String resBase = "C:\\Accessibility\\DataSet\\owleyeDataset\\OSMDashboard1.5.0\\apk\\OSMDashboard-1.5.0\\res";

//        String filename = "mergedXmlBase\\onpcMergeTest.xml";
//        String resBase = "C:\\Accessibility\\DataSet\\owleyeDataset\\onpc1.10\\新建文件夹\\onpc-v1.10\\res";

//        String filename = "mergedXmlBase\\linphone_callMergeTest.xml";
//        String resBase = "C:\\Accessibility\\DataSet\\owleyeDataset\\linphone4.2.3\\linphone-android-debug-4.2.3\\res";

        String filename = "mergedXmlBase\\NoDefectsMergeTest.xml";
